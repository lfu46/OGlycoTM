# generate_supporting_table_S5.R
# Generate Supporting Table S5: Abundance changes of O-GlcNAcylation sites
#
...
de_files <- c(
  "HEK293T" = "/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/differential_analysis/OGlcNAc_site_DE_HEK293T.csv",
  "HepG2" = "/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/differential_analysis/OGlcNAc_site_DE_HepG2.csv",
  "Jurkat" = "/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/differential_analysis/OGlcNAc_site_DE_Jurkat.csv"
)

# Output file
output_file <- "/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/supporting_tables/new_version/supporting_table_S5.xlsx"

# =============================================================================
# Define styles (same as S1-S4)
# =============================================================================
...
for (i in seq_along(cell_types)) {
  ...
  # Title text
  title_text <- paste0("Table S5", sheet_label, ". Abundance changes of O-GlcNAcylation sites in ", cell_type, " cells")
...
cat("Supporting Table S5 saved to:\n", output_file, "\n")
