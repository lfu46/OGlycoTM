...
# Generate Supporting Table S5: Abundance changes of total proteins
#
...
for (i in seq_along(cell_types)) {
  ...
  # Title text
  title_text <- paste0("Table S5", sheet_label, ". Abundance changes of total proteins upon tunicamycin treatment in ", cell_type, " cells")
