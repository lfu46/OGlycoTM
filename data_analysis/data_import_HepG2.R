...
ggsave(
  filename = '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_HepG2/EThcD_OPair_Search_1/Barplot_Total_GlycoPSMs_Unique_Glycoproteins.tiff',
...
ggsave(
  filename = '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_HepG2/EThcD_OPair_Search_1/barplot_Total_GlycoPSM_OGlcNAc_by_raw_file.tiff',
...
ggsave(
  filename = '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_HepG2/EThcD_OPair_Search_1/barplot_Total_GlycoPSM_OGalNAc_by_raw_file.tiff',
