"""
Figure 6E - PWP2 T23 (Q15269) 3D Structure - HepG2
O-GlcNAc site in WD repeat 1 (12-50)

Site: T23
  - logFC: +0.45 (significantly upregulated)
  - pLDDT: 92.69 (very high confidence - structured)
  - Domain: WD repeat 1 (12-50)
  - Cell type: HepG2

Run: /opt/homebrew/bin/pymol -c -q Figure6E_PWP2_T23_pymol.py
"""
...
def highlight_oglcnac_site():
    ...
    # Show side chain as spheres (Threonine)
    cmd.show("spheres", f"{site_name} and (name CB or name OG1 or name CG2)")
...
def setup_view():
    ...
    # PWP2 is a WD repeat protein (beta-propeller), rotate to show structure
    cmd.turn("y", 30)
    cmd.turn("x", -20)
