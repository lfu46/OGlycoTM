...
OGlyco_HEK293T_bonafide <- read_csv(
  '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/OGlyco_HEK293T_bonafide.csv'
)
OGlyco_HepG2_bonafide <- read_csv(
  '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/OGlyco_HepG2_bonafide.csv'
)
OGlyco_Jurkat_bonafide <- read_csv(
  '/Volumes/cos-lab-rwu60/Longping/OGlycoTM_Final_Version/data_source/OGlyco_Jurkat_bonafide.csv'
)
