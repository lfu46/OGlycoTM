"""
Figure 6E - PRDX6 T95 (P30041) 3D Structure - HepG2
O-GlcNAc site in Thioredoxin domain (5-169)

Site: T95
  - logFC: +1.51 (significantly upregulated)
  - pLDDT: 97.62 (very high confidence - structured)
  - Domain: Thioredoxin (5-169)
  - Cell type: HepG2

Run: /opt/homebrew/bin/pymol -c -q Figure6E_PRDX6_T95_pymol.py
"""
