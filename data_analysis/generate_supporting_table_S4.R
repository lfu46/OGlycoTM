...
# Generate Supporting Table S4: Abundance changes of O-GlcNAcylated proteins
#
...
# =============================================================================
# Define styles (same as S1, S2, S3)
# =============================================================================
...
for (i in seq_along(cell_types)) {
  ...
  # Title text
  title_text <- paste0("Table S4", sheet_label, ". Abundance changes of O-GlcNAcylated proteins in ", cell_type, " cells")
